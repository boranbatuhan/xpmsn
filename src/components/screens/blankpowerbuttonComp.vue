<template>
    <div class="fixed top-0 left-0 w-screen h-screen flex items-center justify-center bg-black select-none py-20">
       <div :class="{'pointer-events-none':store.state.startButton}" @click="turnonWindows" class="w-24 h-24 flex items-center justify-center rounded-full border transition-all group hover:border-blue-700 hover:bg-blue-950 shadow-md hover:shadow-blue-400 shadow-transparent scale-95 hover:scale-105 cursor-pointer ">
        <svg class="group-hover:fill-blue-500 fill-zinc-500  transition-all" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 512.292 512.292" style="enable-background:new 0 0 512.292 512.292;" xml:space="preserve" width="64" height="64">
<g>
